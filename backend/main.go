...
func main() {
	...
	if v == "production" {
		...
		e.Use(middleware.CORSWithConfig(middleware.CORSConfig{
			AllowOrigins: []string{"https://heart-beat-mmmommm.vercel.app", "https://heart-beat-mmmommm.vercel.app/en-US", "https://heart-beat-blue.vercel.app/en-US", "https://heart-beat-blue.vercel.app"},
